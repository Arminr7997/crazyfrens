                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                  <div className="flex items-center px-5">
                    ...
                    <a
                      href="#!"
                      type="button"
                      className="rounded-full text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
                    >
                      <svg
                  ...
                  <div className="mt-3 px-2 space-y-1">asdasd</div>
                </div>
              </Disclosure.Panel>
            </Fragment>
          )}
