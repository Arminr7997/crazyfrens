...
const navigation = [
  {
    ...
    href: "#",
    current: true,
    icon: <img src={Images.navHomeIcon} alt="icon" />,
  },
  {
    name: "Products",
    href: "#",
  ...
  },
  {
    ...
    href: "#",
    current: false,
    icon: <img src={Images.navMessagesIcon} alt="icon" />,
  },
];
                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                  <div className="flex items-center px-5">
                    <a
                      href="#!"
                      type="button"
                      className="rounded-full bg-gray-800 text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-10 h-10 m-1 py-2 px-2"
                    >
